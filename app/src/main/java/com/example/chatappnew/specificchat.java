...
public class specificchat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intent = new Intent(this,MessagesAdapter.class);
        intent.putExtra("Sender",senderroom);
        ...
        mbackbuttonofspecificchat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(specificchat.this, chatActivity.class);
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    firebaseDatabase.getReference()
                                            ...
                                            .setValue(messages).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                @Override
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    Toast.makeText(specificchat.this, "MSG SEND", Toast.LENGTH_LONG).show();
