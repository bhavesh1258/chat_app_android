...
public class setProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        msaveprofile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(getApplicationContext(),"Image id Empty",Toast.LENGTH_SHORT).show();
                }
                else
                {
    ...
    {
        senDataTORealTimeDatabase();
    }

    private void senDataTORealTimeDatabase()
    {
    ...
    private void sendImagetoStorage() {
        ...
        uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(getApplicationContext(), "Image Not Updiloaaded", Toast.LENGTH_SHORT).show();
            }
        });
